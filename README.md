...
## D31-8/13/2020 #50daysofudacity
1. Watched Lesson 3 videos
2. Wrote my review-feedback on Eye Exercise App to the Eye Exercise App group
3. Joined study group - #sg_us_et_ct
4. Read and gave my feedback on the third "Did You Know" issue #sg_spaic
...
## D43-8/26/2020 #50daysofudacity

1. Joined Day 3 "GROUP STUDY " with @DIBYENDU PODDAR and @Afreen Kansal.  We completed 11 Lectures; reviewed, watched videos, went over lab and Q&A from Lesson 2: Introduction to Machine Learning.  A wonderful small group open discussion.  
2. Attended Brains@Bay meetup; "The Role of Dendrite in Learning" The 3 speakers; Matthew Larkum (Larkum Lab), Ilenna Jones (Kording Lab) and Blake Richards (Linc Lab) talked about the role of active dendrites in learning from a neuroscience and a computational perspective. The talks were followed by how we can apply what we learn from neuroscience into improving machine learning.  It was not easy to follow through, but studying and (trying to) understand brain/neuroscience is such a fascinating and intriguing area espcially as I am studying ML/DL/AI.  Here is the link to the recording: 
https://www.youtube.com/watch?v=40OEn4Gkebc 
3. Started 50 burpees for 50 day challenge with my sister and friends - Day 1. That was the longest 3:02 of my life - my exercise score has been skyrocketing "0" after the pandemic. Good starting :highfive!
